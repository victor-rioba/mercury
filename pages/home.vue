...
<template>
  ...
  >
    <header class="w-screen h-32 flex justify-between items-center px-10 py-10">
      <div
        class="flex gap-2 items-center justify-center text-viking-500 hover:text-viking-400 font-semibold text-2xl"
      >
        <UIcon name="i-solar-bag-check-broken" />
        <span>mercury.io</span>
      </div>
      <div class="space-x-4">
    ...
    <main class="grid place-content-center h-full text-center px-8 mx-auto">
      <span>
        <UIcon
          ...
          class="text-viking-400 text-[200px]"
        />
      </span>
      <div>
        <span
